...
@TestPropertySource(properties = {
  "spring.datasource.url=jdbc:h2:mem:community-nonempty;MODE=PostgreSQL;DB_CLOSE_DELAY=-1;DATABASE_TO_LOWER=TRUE;INIT=CREATE TABLE IF NOT EXISTS existing_auth_table(id INT)",
...
class CommunityFlywayNonEmptySchemaTest {
  @Autowired
  JdbcTemplate jdbc;
